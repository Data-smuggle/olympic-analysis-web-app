...
def most_successful_countrywise(df,country):
    ...
    x = temp_df['Name'].value_counts().reset_index().rename(columns={'Name':'index','count':'Name'}).head(10).merge(df,left_on='index',right_on='Name',how='left')[['index','Name_x','Sport']].drop_duplicates('index')
    x.rename(columns={'index':'Name','Name_x':'Medals'},inplace=True)
    return x
